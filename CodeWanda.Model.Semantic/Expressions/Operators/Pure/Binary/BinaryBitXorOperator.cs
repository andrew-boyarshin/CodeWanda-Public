...
{
    public class BinaryBitXorOperator : BinaryPureBase
    {
        public static readonly BinaryBitXorOperator Instance = new BinaryBitXorOperator();

        private BinaryBitXorOperator()
        {
        }
